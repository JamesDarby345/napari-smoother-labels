...
_default_shortcuts = {
    ...
    'napari:increment_dims_left': [KeyCode.LeftArrow, KeyCode.KeyA],
    'napari:increment_dims_right': [KeyCode.RightArrow, KeyCode.KeyD],
    ...
    'napari:activate_labels_fill_mode': [KeyCode.Digit4],
    'napari:activate_labels_picker_mode': [KeyCode.Digit5],
    'napari:activate_labels_pan_zoom_mode': [KeyCode.Digit6],
    ...
    'napari:toggle_preserve_labels': [KeyCode.KeyN],
